    ...
    return (
        <React.Fragment>
            ...
            <div className='row' style={{ gap: '8px' }}>
                <Icon target='_blank' href='https://github.com/tonyqiu123/50-days-of-components/tree/main/frontend/src/components/Slider' text='Source code' invert={isDarkMode} image='/Icon/githubIcon.png' />
